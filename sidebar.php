<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      <nav class="mt-2">
        ...
        <?php else: ?>
          <li class="nav-item">
            <a href="./index.php?page=document_list" class="nav-link nav-is-tree nav-edit_document nav-view_document">
              <i title="List of Documents" class="nav-icon fa fa-folder-open"></i>
              <p>
                Documents
              </p>
            </a>
