...
<div class="col-lg-12">
	...
	<?php if($_SESSION['login_type'] == 1 ): ?>
		...
		<tr>
			...
			<th>Number and Series</th>
			<th>Title</th>
			<?php if($_SESSION['login_type'] == 1 ): ?> <th>Uploded by</th> <?php endif; ?>
			<th>Options</th>
		</tr>
		</thead>
			<tbody>
